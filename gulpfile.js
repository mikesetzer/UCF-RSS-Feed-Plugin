...
gulp.task('css-main', function() {
  return gulp.src(config.src.scssPath + '/ucf-rss.scss')
...
// Compile admin js files
gulp.task('js-admin', function() {
  var minified = [
    config.src.jsPath + '/ucf-rss-admin.js'
  ];

  return gulp.src(minified)
    .pipe(concat('ucf-rss-admin.min.js'))
    .pipe(uglify())
